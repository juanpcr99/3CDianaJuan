		...
		while (!finalizo) 
		{
			...
			case 2:
				...
				if(inputLine != null) {
					...
					byte[] cifrar= Cifrado.cifrar(certificadoServidor.getPublicKey(), llaveBytes, ALGA);
					String llaveSim = toByteArrayHexa(cifrar);
			...
			case 3:
				...
				String hashDatos = toByteArrayHexa(hash);
